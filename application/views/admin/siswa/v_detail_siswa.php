 <?php foreach ($siswa->result_array() as $swa) {
    if ($swa['id_siswa'] == $id) {
        ?>
 <div id="page_content">
                    ...
                    <div class="md-card">
                        ...
                        <!-- <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?php echo $swa['nm_siswa']; ?></span><span class="sub-heading"><?php echo $swa['nisn']; ?></span></h2>
                            </div>
                            <a data-uk-tooltip="{pos:'top'}" title="Edit" href="#" data-uk-modal="{target:'#edit_siswa_<?php echo $swa['id_siswa']; ?>'}" class="md-fab md-fab-small md-fab-accent">
                        ...
                        <form id="edit-foto-siswa">
                                <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="<?php echo base_url() ?>images/siswa/<?=$swa['foto_siswa']?>" alt=""/>
                                    </div>
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate" id="user_edit_uname"><?php echo $swa['nm_siswa']; ?></span><span class="sub-heading" id="user_edit_position"><?php echo $swa['nisn']; ?></span></h2>
                                </div>
                                ...
                                <a data-uk-tooltip="{pos:'top'}" title="Edit Data" href="#" data-uk-modal="{target:'#edit_siswa_<?php echo $swa['id_siswa']; ?>'}" class="md-fab md-fab-small md-fab-accent">
                            ...
                            <script>
                                $('#edit-foto-siswa').submit(function(e) {
                                    ...
                                    $.ajax({
                                        type : "POST",
                                        url : "<?php echo base_url('proses/ganti_foto_siswa/') . $swa['id_siswa'] ?>",
                        ...
                        <div class="user_content">
                            ...
                            <ul id="user_profile_tabs_content" class="uk-switcher">
                                ...
                                <div class="uk-grid uk-margin-medium-top uk-margin-large-bottom" data-uk-grid-margin>
                                        <div class="uk-width-large-1-<?= ($akun['level'] == 3) ? 2 : 3 ?>">
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['nis']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['nisn']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['jk']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['agama']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['tempat']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">
                                                            <?php if ($swa['tanggal_lahir'] == '0000-00-00') {echo "";} else {
            echo tgl_indo($swa['tanggal_lahir']);}?>
                                                            </span>
                                        ...
                                        <div class="uk-width-large-1-<?= ($akun['level'] == 3) ? 2 : 3 ?>">
                                            <ul class="md-list">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['jalan']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['kel']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['kec']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['kab']; ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['prov']; ?></span>
                                                ...
                                                <!-- <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php echo $swa['pdd_sb']; ?></span>
                                        ...
                                        <div class="uk-width-large-1-3">
                                            ...
                                            <ul class="md-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a data-uk-tooltip="{pos:'top'}" target="_blank" title="Report R-1" href="<?=base_url('cetak/cetak_r1/' . $id . '/' . $swa['nis'])?>"  class="md-btn md-btn-small md-btn-danger md-btn-wave-light"><i class="fas fa-print">&nbsp;</i>Report R-1</a>
                                                    <br>
...
$tjr = $this->db->query("SELECT * FROM tb_tahunajaran");
        foreach ($tjr->result() as $ta) {?>
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td>
                                                                <a data-uk-tooltip="{pos:'top'}" target="_blank" title="Report R-2" href="<?=base_url('cetak/cetak_r2/' . $id . '/' . $swa['nis'] . '/' . $id_tj)?>"  class="md-btn md-btn-small md-btn-danger md-btn-wave-light"><i class="fas fa-print">&nbsp;</i>Report R-2</a>
                                                            </td>
                                                        </tr>
                                                    <?php }?>
                                                    </table>
...
$n = 1;
            ...
            $nki3   = $this->db->query("SELECT * FROM tb_nki1 WHERE siswa=".$id." AND ta=" . $id_tj . "");
            $ski1   = $this->m_admin->data_sikap_ki1();

            $lgt = $this->db->query("SELECT * FROM tb_sikap_ki1 WHERE siswa=" . $id . " AND ta=" . $id_tj . "")->num_rows();
            if ($lgt == 0) {
                $no = 1;
...
$x = 1;
            ...
            $nki4   = $this->db->query("SELECT * FROM tb_nki2 WHERE siswa=".$id." AND ta=" . $id_tj . "");
            $ski2   = $this->m_admin->data_sikap_ki2();

            $lgt = $this->db->query("SELECT * FROM tb_sikap_ki2 WHERE siswa=" . $id . " AND ta=" . $id_tj . " ")->num_rows();
            if ($lgt == 0) {
                $no = 1;
                foreach ($siswa->result() as $sw) {
                    if ($sw->id_siswa == $id) {
        ...
        <?php }?>
            ...
            ?>
                ...
                echo "selected";
                                    ...
                                    <?php foreach ($tahunajaran->result() as $ta) {
            ?>
                                            <div class="md-card" id="tab-nilai-<?=$id_tj?>">
                                                <div class="md-card-content">
                                                            <h5 style="background:<?php if ($ta->stt_tahunajaran == 'Y') {echo "yellow";}?>"><b><?=$ta->nm_tahunajaran?></b></h5>
                                                    <hr>

                                                    <ul class="uk-tab" data-uk-tab="{connect:'#tabs_nilai_<?=$id_tj?>'}">
                                                        <li class="uk-active"><a href="#">Pengetahuan</a></li>
                                                        <li><a href="#">Keterampilan</a></li>
                                                    </ul>
                                                    <ul id="tabs_nilai_<?=$id_tj?>" class="uk-switcher uk-margin">
                                                        <li>
                                                            <div class="table-responsive">
                                                            <table class="uk-table" border="1">
                                                                <tr>
...
$no = 1;
            foreach ($mapel->result() as $mp) {
                echo '
                                                                <tr>
                                                                    <td>' . $no++ . '</td>
                                                                    <td>' . $mp->nm_mapel . '</td>';
                $nph = $this->db->query("SELECT AVG(ph) as total_ph FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . " ")->result();

                $nuts = $this->db->query("SELECT AVG(npts) as total_uts FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . " ")->result();

                $nuas = $this->db->query("SELECT AVG(npas) as total_uas FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . " ")->result();

                $jum = $this->db->query("SELECT (SELECT AVG(ph) FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . ") + (SELECT AVG(npts) FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . ") + (SELECT AVG(npas) FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . ") as jumlah")->result();
            ...
            $jum_ph  = $this->db->query("SELECT AVG(ph) as jumlah_ph FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " ")->result();
            $jum_uts = $this->db->query("SELECT AVG(npts) as jumlah_uts FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " ")->result();
            $jum_uas = $this->db->query("SELECT AVG(npas) as jumlah_uas FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . " ")->result();

            $jum_k = $this->db->query("SELECT (SELECT AVG(ph) FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . ") + (SELECT AVG(npts) FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . ") + (SELECT AVG(npas) FROM tb_nki3 WHERE siswa=" . $id . " AND ta=" . $id_tj . ") as jumlah_k")->result();
...
$no = 1;
            foreach ($mapel->result() as $mp) {
                echo '
                                                                <tr>
                                                                    <td>' . $no++ . '</td>
                                                                    <td>' . $mp->nm_mapel . '</td>';
                $nph = $this->db->query("SELECT AVG(ph) as total_ph FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . " ")->result();

                $nuts = $this->db->query("SELECT AVG(npts) as total_uts FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . " ")->result();

                $nuas = $this->db->query("SELECT AVG(npas) as total_uas FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . " ")->result();

                $jum = $this->db->query("SELECT (SELECT AVG(ph) FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . ") + (SELECT AVG(npts) FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . ") + (SELECT AVG(npas) FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " AND mapel=" . $mp->id_mapel . ") as jumlah")->result();
            ...
            $jum_ph  = $this->db->query("SELECT AVG(ph) as jumlah_ph FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " ")->result();
            $jum_uts = $this->db->query("SELECT AVG(npts) as jumlah_uts FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " ")->result();
            $jum_uas = $this->db->query("SELECT AVG(npas) as jumlah_uas FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . " ")->result();

            $jum_k = $this->db->query("SELECT (SELECT AVG(ph) FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . ") + (SELECT AVG(npts) FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . ") + (SELECT AVG(npas) FROM tb_nki4 WHERE siswa=" . $id . " AND ta=" . $id_tj . ") as jumlah_k")->result();
            ...
            ?>
                ...
                echo "selected";
                                    ...
                                    <?php foreach ($tahunajaran->result() as $ta) {
            ?>
                                            <div class="md-card" id="tab-leger-<?=$id_tj?>">
                                                <div class="md-card-content">
                                                    <h5 style="background:<?php if ($ta->stt_tahunajaran == 'Y') {echo "yellow";}?>"><b><?=$ta->nm_tahunajaran?></b></h5>
                                                    <hr>
                ...
                if ($sw->id_siswa == $id) {
                    ?>
                                    <tr>
                                        ...
                                        <?php foreach ($mapel->result() as $mp) {
                        $avg3 = $this->db->query("SELECT AVG(total_na) as avg3 FROM tb_nilai_ki3 WHERE siswa=" . $sw->id_siswa . " AND mapel=" . $mp->id_mapel . " AND ta=" . $id_tj . "");
                        if ($avg3->num_rows() == 0) {
                        ...
                        if ($k1->siswa == $sw->id_siswa && $k1->ta == $id_tj) {?>
                                    <td rowspan="2" style="vertical-align: inherit; text-align: center;"><?=$k1->predikat?></td>
                                <?php }}?>

                                <?php foreach ($ki2->result() as $k2) {
                        if ($k2->siswa == $sw->id_siswa && $k2->ta == $id_tj) {?>
                                    <td rowspan="2" style="vertical-align: inherit; text-align: center;"><?=$k2->predikat?></td>
                                <?php }}?>

                                <td>
                                    <?php
$sum3 = $this->db->query("SELECT SUM(total_na) as jml FROM tb_nilai_ki3 WHERE siswa=" . $sw->id_siswa . " AND ta=" . $id_tj . " ")->result();
                    ...
                    ?>
                                ...
                                <td>
                                    ...
                                    <?php
$avg3 = $this->db->query("SELECT AVG(total_na) as jml FROM tb_nilai_ki3 WHERE siswa=" . $sw->id_siswa . " AND ta=" . $id_tj . " ")->result();
                    ...
                    ?>
                                ...
                                <td rowspan="2" style="vertical-align: inherit; text-align: center;">
                                    <?php
$nrpk = $this->db->query("SELECT (SELECT AVG(total_na) FROM tb_nilai_ki3 WHERE siswa=" . $sw->id_siswa . " AND ta=" . $id_tj . ") + (SELECT AVG(total_na) FROM tb_nilai_ki4 WHERE siswa=" . $sw->id_siswa . " AND ta=" . $id_tj . ") as result ")->result();
                        ...
                        ?>
                            ...
                            <?php }?>
                                    ...
                                    <tr>
                                        <td>Keterampilan</td>
                                        <?php foreach ($mapel->result() as $mp) {
                        $avg4 = $this->db->query("SELECT AVG(total_na) as avg4 FROM tb_nilai_ki4 WHERE siswa=" . $sw->id_siswa . " AND mapel=" . $mp->id_mapel . " AND ta=" . $id_tj . "")->result();
                        foreach ($avg4 as $av4) {
                            ?>
                                    ...
                                    <td>
                                           <?php
$sum4 = $this->db->query("SELECT SUM(total_na) as jml FROM tb_nilai_ki4 WHERE siswa=" . $sw->id_siswa . " AND ta=" . $id_tj . " ")->result();
                    ...
                    ?>
                                    ...
                                    <td>
                                         <?php
$avg4 = $this->db->query("SELECT AVG(total_na) as jml FROM tb_nilai_ki4 WHERE siswa=" . $sw->id_siswa . " AND ta=" . $id_tj . " ")->result();
...
<div class="uk-modal" id="edit_absiswa">
    ...
    <?php foreach ($siswa->result_array() as $sw) {
            ?>
<div class="uk-modal" id="edit_siswa_<?php echo $swa['id_siswa'] ?>">
      <div class="uk-modal-dialog" style="width: 1000px;">
        <div class="uk-modal-header">
            <div class="uk-grid">
                <div class="uk-width-7-10">
    ...
    <div class="uk-grid">
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    <label>NIS</label>
                    <input class="md-input" id="nis2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['nis'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>NISN</label>
                    <input class="md-input" id="nisn2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['nisn'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Nama</label>
                    <input class="md-input" id="nm_siswa2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['nm_siswa'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Jenis Kelamin</label><br><br>
                        <span class="icheck-inline">
                            <input type="radio" name="jk2-<?php echo $swa['id_siswa'] ?>" id="jk2-<?php echo $swa['id_siswa'] ?>" <?php if ($swa['jk'] == 'L') {
                echo "checked";
            }?> value="L" data-md-icheck required="" />
                            <label class="inline-label">L</label>
                        </span>
                        <span class="icheck-inline">
                            <input type="radio" name="jk2-<?php echo $swa['id_siswa'] ?>" id="jk2-<?php echo $swa['id_siswa'] ?>" <?php if ($swa['jk'] == 'P') {
                echo "checked";
                ...
                <div class="uk-form-row">
                    <label>Agama</label>
                    <input class="md-input" id="agama2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['agama'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Tempat Lahir</label>
                    <input class="md-input" id="tempat2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['tempat'] ?>" autocomplete="off">
                </div>
            </div>
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    <label>Tanggal Lahir</label>
                    <input type="date" class="md-input" id="tanggal_lahir2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['tanggal_lahir'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Jalan</label>
                    <input class="md-input" id="jalan2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['jalan'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Kelurahan</label>
                    <input class="md-input" id="kel2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['kel'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Kecamatan</label>
                    <input class="md-input" id="kec2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['kec'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Kabupaten</label>
                    <input class="md-input" id="kab2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['kab'] ?>" autocomplete="off">
                </div>
                <div class="uk-form-row">
                    <label>Provinsi</label>
                    <input class="md-input" id="prov2-<?php echo $swa['id_siswa'] ?>" value="<?php echo $swa['prov'] ?>" autocomplete="off">
                </div>

                <input type="hidden" name="pdd_sb2-<?php echo $swa['id_siswa'] ?>" value="">

                <!-- <div class="uk-form-row">
                    <label>Pendidikan Sebelumnya (TK)</label><br><br>
                        <span class="icheck-inline">
                            <input type="radio" name="pdd_sb2-<?php echo $swa['id_siswa'] ?>" id="pdd_sb2-<?php echo $swa['id_siswa'] ?>" <?php if ($swa['pdd_sb'] == 'Ya') {
                echo "checked";
            }?> value="Ya" data-md-icheck required="" />
                            <label class="inline-label">Ya</label>
                        </span>
                        <span class="icheck-inline">
                            <input type="radio" name="pdd_sb2-<?php echo $swa['id_siswa'] ?>" id="pdd_sb2-<?php echo $swa['id_siswa'] ?>" <?php if ($swa['pdd_sb'] == 'Tidak') {
                echo "checked";
        ...
        <h5>Data Akun untuk melakukan login:</h5>
        <input type="hidden" id="old_password-<?php echo $swa['id_siswa'] ?>" value="<?= $swa['password'] ?? '12345' ?>">
        <input type="hidden" id="id_akun-<?php echo $swa['id_siswa'] ?>" value="<?= $swa['id_akun'] ?>">
        <div class="uk-grid">
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    <label>Username</label>
                    <input class="md-input" id="username2-<?php echo $swa['id_siswa'] ?>" placeholder="Jika kosong maka default nya adalah Nis" value="<?= $swa['username'] ?>" autocomplete="off">
                </div>
            </div>
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    <label>Password</label>
                    <input class="md-input" id="password2-<?php echo $swa['id_siswa'] ?>" placeholder="********" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="uk-text-right">
            <button class="md-btn md-btn-primary" onclick="edit_siswa(<?php echo $swa['id_siswa'] ?>)">Simpan</button>
        </div>
...
<div class="uk-modal" id="edit_prestasi">
      ...
      <script>
        ...
        function edit_siswa(id) {
            ...
            var username = $("#username2-"+id).val();
            var password = $("#password2-"+id).val();
            var id_akun = $("#id_akun-"+id).val();
            var old_password = $("#old_password-"+id).val();
            var id_siswa = id;
...
var thisDay = date.getDay(),
    ...
    var id_smt = document.getElementById('id_smt').value;
                ...
                function tampil_absiswa() {
                        $.ajax({
                            type : 'ajax',
                            url : '<?=base_url('proses/get_absiswa/' . $id . '/' . $akun['level'])?>',
                            success: function(data) {
            ...
            function key_alpha(id) {
                ...
                // FISIK
                    ...
                    function tampil_fisik() {
                        $.ajax({
                            type : 'ajax',
                            url : '<?=base_url('proses/get_fisik/' . $id . '/' . $akun['level'])?>',
                            success: function(data) {
                ...
                // KESEHATAN
                    ...
                    function tampil_kesehatan() {
                        $.ajax({
                            type : 'ajax',
                            url : '<?=base_url('proses/get_kesehatan/' . $id . '/' . $akun['level'])?>',
                            success: function(data) {
            ...
            function tampil_ekskul() {
                $.ajax({
                    type : 'ajax',
                    url : '<?=base_url('proses/get_ekskul/' . $id . '/' . $akun['level'])?>',
                    success: function(data) {
            ...
            function tampil_prestasi() {
                $.ajax({
                    type : 'ajax',
                    url : '<?=base_url('proses/get_prestasi/' . $id . '/' . $akun['level'])?>',
                    success: function(data) {
