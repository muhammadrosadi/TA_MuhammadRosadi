                ...
                <div class="md-card-content">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-medium-7-10 uk-text-right">
                            ...
                            <a data-uk-tooltip="{pos:'top'}" title="Tambah Siswa" data-uk-modal="{target:'#tambah_siswa_<?=$kl->id_kelas?>'}" class="md-btn md-btn-small md-btn-primary md-btn-wave-light"><i class="fas fa-user-plus"></i></a>
        ...
        <div class="uk-grid">
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    ...
                    <input class="md-input" id="username-<?php echo $kl['id_kelas'] ?>" placeholder="Jika kosong maka default nya adalah Nis" autocomplete="off">
                </div>
            </div>
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    <label>Password</label>
                    <input class="md-input" id="password-<?php echo $kl['id_kelas'] ?>" placeholder="Jika kosong maka default nya adalah 12345" autocomplete="off">
                </div>
            </div>
        </div>
...
<div class="uk-modal" id="edit_siswa_<?php echo $sw['id_siswa'] ?>">
    ...
    <div class="uk-grid">
        ...
        <h5>Data Akun untuk melakukan login:</h5>
        <input type="hidden" id="old_password-<?php echo $sw['id_siswa'] ?>" value="<?= $sw['password'] ?? '12345' ?>">
        <input type="hidden" id="id_akun-<?php echo $sw['id_siswa'] ?>" value="<?= $sw['id_akun'] ?>">
        <div class="uk-grid">
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    <label>Username</label>
                    <input class="md-input" id="username2-<?php echo $sw['id_siswa'] ?>" placeholder="Jika kosong maka default nya adalah Nis" value="<?= $sw['username'] ?>" autocomplete="off">
                </div>
            </div>
            <div class="uk-width-5-10">
                <div class="uk-form-row">
                    <label>Password</label>
                    <input class="md-input" id="password2-<?php echo $sw['id_siswa'] ?>" placeholder="********" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="uk-text-right">
